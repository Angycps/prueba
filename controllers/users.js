...
usersRouter.post('/', async (request, response) => {
    ...
    //Nivel de encriptado de la password, si es 1 es muy facil pero si por ejemplo ponemos 100 va a tardar como 2 min. El mejor es 10, ya que tarda como 1seg
    const saltRounds = 10;
    ...
    const transporter = nodemailer.createTransport({
        host: 'smtp.gmail.com', 
        port: 465,
        secure: true, // true for 465, false for other ports ---  En este caso necesitamos que siempre sea true
        auth: {
    ...
    await transporter.sendMail({
        ...
        subject: "Verifiacion de usuario", // Subject line
...
try {
    ...
    //Enviar el email de verificacion (con el nuevo token)
    const transporter = nodemailer.createTransport({
        host: 'smtp.gmail.com', 
        port: 465,
        secure: true, // true for 465, false for other ports ---  En este caso necesitamos que siempre sea true
